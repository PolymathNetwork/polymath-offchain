...
export default ({ issuerName, issuerEmail, providerName, application }: {
  issuerName: string,
  issuerEmail: string,
  providerName: string,
  application: {
      ...
      <body>
        <div className='wrapper'>
          ...
          <div className='content'>
            <h1>Hi,</h1>
            <h2>
              <strong style={{ color: '#3D70B2' }}>{application.companyName} </strong>
              has applied to work with you.<br />Below are the details of their business:
            </h2>
            <div className='text'>
